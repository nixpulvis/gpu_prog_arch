...
.text
    ...
    # If none of the workers will execute the first part of
    ...
    # If none of the workers will execute the second part of
    # the conditional, branch to the end.
    s_cbranch_execz end

    # Subtract source elements.
    v_sub_i32 v22, vcc, v20, v21
end:
    # Restore the active mask.
